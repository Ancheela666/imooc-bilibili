...
public class UserMomentsApi {
    ...
    //用户发布动态
    @ApiLimitedRole(limitedRoleCodeList = {AuthRoleConstant.ROLE_LV0}) //自定义接口权限控制注解
    @DataLimited //自定义数据权限控制注解
    ...
    public JsonResponse<List<UserMoment>> getUserSubscribedMoments(){
        Long userId = userSupport.getCurrentUserId();
        List<UserMoment> momentList = userMomentsService.getUserSubscribedMoments(userId);
